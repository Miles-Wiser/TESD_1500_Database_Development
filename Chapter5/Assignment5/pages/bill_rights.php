...
?>
    ...
    <main>
        ...
        <h4>(ratified December 15, 1791)</h4>
        ...
        <h2>Eleventh Amendment</h2>
        <h4>Passed by Congress March 4, 1794. Ratified February 7, 1795.</h4>
        <p>Note: Article III, section 2, of the Constitution was modified by
            amendment 11.
        </p>
        ...
        <h2>Twelfth Amendment</h2>
        <h4>Passed by Congress December 9, 1803. Ratified June 15, 1804.</h4>
        ...
        <p class="notation">*Superseded by section 3 of the 20th amendment.</p>

        <h2>Thirteenth Amendment</h2>
        <h4>Passed by Congress January 31, 1865. Ratified December 6, 1865.</h4>
        <p>Note: A portion of Article IV, section 2, of the Constitution was
            superseded by the 13th amendment.
        </p>

        <h3>Section 1.</h3>
        <p>Neither slavery nor involuntary servitude, except as a punishment for
        ...
        <h4>Passed by Congress June 13, 1866. Ratified July 9, 1868.</h4>
        ...
        <h3>Section 2.</h3>
        <p>Representatives shall be apportioned among the several States according
        ...
        <h3>Section 4.</h3>
        <p>The validity of the public debt of the United States, authorized by
        ...
        <h3>Section 5.</h3>
        <p>The Congress shall have the power to enforce, by appropriate
            legislation, the provisions of this article.
        </p>
        <p class="notation">*Changed by section 1 of the 26th amendment.</p>

        <h2>Fifteenth Amendment</h2>
        <h4>Passed by Congress February 26, 1869. Ratified February 3, 1870.</h4>
        ...
        <h3>Section 2.</h3>
        <p>The Congress shall have the power to enforce this article by appropriate
            legislation.
        </p>

        <h2>Sixteenth Amendment</h2>
        <h4>Passed by Congress July 2, 1909. Ratified February 3, 1913.</h4>
        <p>Note: Article I, section 9, of the Constitution was modified by
            amendment 16.
        </p>
        <p>The Congress shall have power to lay and collect taxes on incomes,
            from whatever source derived, without apportionment among the
            several States, and without regard to any census or enumeration.
        </p>

        <h2>Seventeenth Amendment</h2>
        <h4>Passed by Congress May 13, 1912. Ratified April 8, 1913.</h4>
        <p>Note: Article I, section 3, of the Constitution was modified by the
            17th amendment.
        </p>
        ...
        <p>When vacancies happen in the representation of any State in the
        ...
        <p>
        <p>This amendment shall not be so construed as to affect the election or
            term of any Senator chosen before it becomes valid as part of the
            Constitution.
        </p>

        <h2>Eighteenth Amendment</h2>
        <h4>Passed by Congress December 18, 1917. Ratified January 16, 1919.
        ...
        <div id="eighteenth">
            ...
            <h3>Section 3.</h3>
            <p>This article shall be inoperative unless it shall have been ratified
        ...
        <h4>Passed by Congress June 4, 1919. Ratified August 18, 1920.</h4>
        <p>The right of citizens of the United States to vote shall not be denied
        ...
        <h2>Twentieth Amendment</h2>
        <h4>Passed by Congress March 2, 1932. Ratified January 23, 1933.</h4>
        <p>Note: Article I, section 4, of the Constitution was modified by
            section 2 of this amendment. In addition, a portion of the 12th
            amendment was superseded by section 3.
        </p>
        <h3>Section 1.</h3>
        <p>The terms of the President and the Vice President shall end at noon
        ...
        <h3>Section 3.</h3>
        <p>If, at the time fixed for the beginning of the term of the President,
            ...
            eclaring who shall then act as President, or the manner in which one
            who is to act shall be selected, and such person shall act
            accordingly until a President or Vice President shall have qualified.
        </p>
        <h3>Section 4.</h3>
        <p>The Congress may by law provide for the case of the death of any of
        ...
        <h3>Section 5.</h3>
        <p>Sections 1 and 2 shall take effect on the 15th day of October following
            the ratification of this article.
        </p>
        <h3>Section 6.</h3>
        <p>This article shall be inoperative unless it shall have been ratified as
        ...
        <h2>Twenty-First Amendment</h2>
        <h4>Passed by Congress February 20, 1933. Ratified December 5, 1933.</h4>
        <h3>Section 1.</h3>
        <p>The eighteenth article of amendment to the Constitution of the United
            States is hereby repealed.
        </p>
        <h3>Section 2.</h3>
        <p>The transportation or importation into any State, Territory, or
        ...
        <h4>Passed by Congress March 21, 1947. Ratified February 27, 1951.</h4>
        <h3>Section 1.</h3>
        ...
        <h2>Twenty-Third Amendment</h2>
        <h4>Passed by Congress June 16, 1960. Ratified March 29, 1961.</h4>
        <h3>Section 1.</h3>
        <p>The District constituting the seat of Government of the United States
            shall appoint in such manner as the Congress may direct:
        </p>
        <p>A number of electors of President and Vice President equal to the whole
        ...
        <h2>Twenty-Fourth Amendment</h2>
        <h4>Passed by Congress August 27, 1962. Ratified January 23, 1964.
        <h3>Section 1.</h3>
        ...
        <h2>Twenty-Fifth Amendment</h2>
        <h4>Passed by Congress July 6, 1965. Ratified February 10, 1967.</h4>
        <p>Note: Article II, section 1, of the Constitution was affected by the
            25th amendment.
        </p>
        <h3>Section 1.</h3>
        <p>In case of the removal of the President from office or of his death or
            resignation, the Vice President shall become President.
        </p>
        <h3>Section 2.</h3>
        <p>Whenever there is a vacancy in the office of the Vice President, the
            President shall nominate a Vice President who shall take office upon
            confirmation by a majority vote of both Houses of Congress.
        </p>
        <h3>Section 3.</h3>
        <p>Whenever the President transmits to the President pro tempore of the
        ...
        <h3>Section 4.</h3>
        <p>Whenever the Vice President and a majority of either the principal
        ...
        <p>Thereafter, when the President transmits to the President pro tempore
        ...
        <h2>Twenty-Sixth Amendment</h2>
        <h4>Passed by Congress March 23, 1971. Ratified July 1, 1971.</h4>
        <p>Note: Amendment 14, section 2, of the Constitution was modified by
            section 1 of the 26th amendment.
        </p>
        <h3>Section 1.</h3>
        <p>The right of citizens of the United States, who are eighteen years
        ...
        <h2>Twenty-Seventh Amendment</h2>
        <h4>Originally proposed Sept. 25, 1789. Ratified May 7, 1992.</h4>
        <p>No law, varying the compensation for the services of the Senators an
